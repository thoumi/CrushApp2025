...
- Documentation complète : [thoumi.github.io/HalloApp](https://thoumi.github.io/HalloApp)
...
- [Fonctionnalités Détaillées](01-FONCTIONNALITES-SIMPLE.md) : Documentation technique
...
Le code est visible publiquement à des fins d'évaluation technique (voir
[LICENSE](../../LICENSE)), mais n'est pas open source.

- **Repository GitHub** : [github.com/thoumi/HalloApp](https://github.com/thoumi/HalloApp)
